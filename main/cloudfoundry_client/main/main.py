...
def main():
    ...
    commands = [
        ...
        AppCommandDomain(),
        CommandDomain(display_name='Services', entity_name='service', filter_list_parameters=['service_broker_guid'],
                      name_property='label', allow_retrieve_by_name=True, allow_creation=True, allow_deletion=True),
        CommandDomain(display_name='Service Plans', entity_name='service_plan',
                      filter_list_parameters=['service_guid', 'service_instance_guid', 'service_broker_guid']),
        CommandDomain(display_name='Service Instances', entity_name='service_instance',
                      filter_list_parameters=['organization_guid', 'space_guid', 'service_plan_guid'],
                      allow_creation=True, allow_deletion=True),
        CommandDomain(display_name='Service Keys', entity_name='service_key',
                      filter_list_parameters=['service_instance_guid'],
                      allow_creation=True, allow_deletion=True),
        CommandDomain(display_name='Service Bindings', entity_name='service_binding',
